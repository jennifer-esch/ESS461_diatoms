...
navicula_data = pd.read_csv('navicula_abundance.csv', header=None)
navicula_data.head()

Year = navicula_data[0]
Abundance = navicula_data[1]
...
plt.xlabel('Abundance of Navicula')
...
plt.title('Abundance of Navicula across Core')
